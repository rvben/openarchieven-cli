    ...
    Command {
        ...
        args: vec![
            Arg {
                ...
                required: true,
                positional: true,
                description: Some("Full-text query to search across page transcriptions"),
                default: None,
                min: None,
                max: None,
                r#enum: None,
            ...
            Arg {
                ...
                required: false,
                positional: false,
                description: Some("Filter results to a specific archive number within the archive"),
                default: None,
                min: None,
                max: None,
                r#enum: None,
            ...
            Arg {
                ...
                required: false,
                positional: false,
                description: Some("Filter results to a specific inventory number"),
                default: None,
                min: None,
                max: None,
                r#enum: None,
            ...
            Arg {
                ...
                required: false,
                positional: false,
                description: Some("Filter results to documents starting from this year"),
                default: None,
                min: None,
                max: None,
                r#enum: None,
            ...
            Arg {
                ...
                required: false,
                positional: false,
                description: Some("Filter results to documents up to and including this year"),
                default: None,
                min: None,
                max: None,
                r#enum: None,
        ...
        output_fields: vec![
            OutputField {
                ...
                description: Some("Transcription match objects from /response/docs"),
            },
            OutputField {
                name: "total",
                ty: "integer | null",
                description: Some(
                    "Total hit count from /response/number_found; null if unavailable",
                ),
            },
            OutputField {
                name: "limit",
