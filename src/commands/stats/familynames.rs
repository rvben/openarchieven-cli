    ...
    Command {
        ...
        args: vec![
            Arg {
                ...
                required: false,
                positional: false,
                description: Some("Filter by event place name"),
                default: None,
                min: None,
                max: None,
                r#enum: None,
            ...
            Arg {
                ...
                required: false,
                positional: false,
                description: Some("Maximum number of family names to return (1-100)"),
        ...
        output_fields: vec![
            OutputField {
                name: "items",
                ty: "array<row>",
                description: Some("Family name frequency rows, each with name and count fields"),
            },
            OutputField {
                name: "total",
                ty: "integer",
