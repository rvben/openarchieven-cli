    ...
    Command {
        ...
        args: vec![
            Arg {
                ...
                required: true,
                positional: false,
                description: Some("Event place name to retrieve first-name frequency for"),
                default: None,
                min: None,
                max: None,
                r#enum: None,
            ...
            Arg {
                ...
                required: true,
                positional: false,
                description: Some("Event year to retrieve first-name frequency for (1600-1960)"),
                default: None,
            ...
            Arg {
                ...
                required: false,
                positional: false,
                description: Some("Maximum number of first names to return (1-100)"),
        ...
        output_fields: vec![
            OutputField {
                name: "items",
                ty: "array<row>",
                description: Some("First name frequency rows from /response/firstnames"),
            },
            OutputField {
                name: "total",
                ty: "integer",
                description: Some("Number of rows returned after applying the limit"),
            },
            OutputField {
                name: "limit",
                ty: "integer",
                description: Some("Maximum number of rows requested"),
            },
            OutputField {
                name: "paginated",
                ty: "boolean",
