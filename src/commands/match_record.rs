    ...
    Command {
        ...
        args: vec![
            Arg {
                ...
                required: true,
                positional: true,
                description: Some("Full name of the person to match"),
                default: None,
                min: None,
                max: None,
                r#enum: None,
            ...
            Arg {
                ...
                required: true,
                positional: true,
                description: Some("Birth year used together with name for probabilistic matching"),
                default: None,
                min: None,
                max: None,
                r#enum: None,
        ...
        output_fields: vec![
            ...
            OutputField {
                name: "total",
                ty: "integer | null",
                description: Some("Total match count from /response/numFound; null if unavailable"),
            },
            OutputField {
                name: "paginated",
                ty: "boolean",
