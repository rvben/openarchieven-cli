    ...
    Command {
        ...
        args: vec![
            Arg {
                ...
                required: true,
                positional: false,
                description: Some("Census year to retrieve data for"),
                default: None,
                min: None,
                max: None,
                r#enum: None,
            ...
            Arg {
                ...
                required: false,
                positional: false,
                description: Some("Place name; mutually exclusive with --gg-uri"),
                default: None,
                min: None,
                max: None,
                r#enum: None,
            ...
            Arg {
                ...
                positional: false,
                description: Some(
                    "Gemeentegeschiedenis URI for the place; mutually exclusive with --place",
                ),
                default: None,
                min: None,
                max: None,
            ...
            Arg {
                ...
                required: false,
                positional: false,
                description: Some("Province filter to narrow census results"),
                default: None,
                min: None,
                max: None,
                r#enum: None,
            ...
            Arg {
                ...
                required: false,
                positional: false,
                description: Some("Level of detail to include: 1=basic, 2=full, 3=aggregated"),
                default: None,
                min: Some(1),
                max: Some(3),
                r#enum: Some(vec![
