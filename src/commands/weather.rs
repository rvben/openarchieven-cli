    ...
    Command {
        ...
        args: vec![
            Arg {
                ...
                positional: false,
                description: Some(
                    "Date in YYYY-MM-DD format for which to retrieve weather observations",
                ),
                default: None,
                min: None,
                max: None,
            ...
            Arg {
                ...
                required: true,
                positional: false,
                description: Some("Decimal longitude of the location"),
                default: None,
                min: None,
                max: None,
                r#enum: None,
            ...
            Arg {
                ...
                required: true,
                positional: false,
                description: Some("Decimal latitude of the location"),
                default: None,
                min: None,
                max: None,
                r#enum: None,
        ...
        output_fields: vec![
            OutputField {
                ...
                description: Some(
                    "Weather observation objects for the requested date and coordinate",
                ),
            },
            OutputField {
                name: "total",
                ty: "integer",
                description: Some("Number of observation objects in this response"),
            },
            OutputField {
                name: "limit",
                ty: "null",
